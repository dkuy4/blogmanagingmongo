      ...
      <header className="bg-slate-900 text-white shadow-xl border-b border-emerald-500/30 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 font-mono mt-0.5">
                HỆ THỐNG QUẢN LÝ BLOG VÀ BÀI VIẾT
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
            ...
            {/* Tab Selection Navbar - Compacted to ~2/3 of original width */}
            <nav className="flex bg-slate-800 p-1 rounded-xl border border-slate-700 overflow-x-auto gap-0.5 max-w-[650px]">
              <button
                onClick={() => { setActiveTab('reader'); setSelectedPost(null); }}
                className={`flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-semibold rounded-lg transition-all duration-200 whitespace-nowrap ${
                  activeTab === 'reader' 
